...
//------------------------------------------------------------------------------
// Clocked THREAD: minst_threadProc (example.cpp:31:5) 
...
always_comb begin : minst_threadProc_comb     // example.cpp:31:5
...
//------------------------------------------------------------------------------
// Clocked THREAD: minst_threadProc0 (example.cpp:31:5) 
...
// Next-state combinational logic
always_comb begin : minst_threadProc0_comb     // example.cpp:31:5
