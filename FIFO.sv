...
localparam logic [31:0] N = 4000000;

//------------------------------------------------------------------------------
// Clocked THREAD: tests (example.cpp:75:5) 
...
always_comb begin : tests_comb     // example.cpp:75:5
    tests_func;
end
    ...
    case (tests_PROC_STATE)
        0: begin
            if (tests_WAIT_N_COUNTER != 1) begin
                ...
                tests_PROC_STATE_next = 0; return;    // example.cpp:77:9;
            end;
            nrst_next = 1;
            i_next = 0;
            in_next = i_next;
            tests_PROC_STATE_next = 1; return;    // example.cpp:82:13;
        end
        1: begin
            i_next++;
            if (i_next < N)
